 ...
 *          detection since RSTn shares its NVIC vector (EXTI9_5) with
 *          DW_IRQn on this board.
 * */
 ...
 * @brief   ~2.8 MHz - safe rate before the DW IC crystal oscillator is confirmed running
 *          (APB2 = 90 MHz / 32)
 * */
 ...
 * @brief   ~11.25 MHz - steady-state rate once the DW IC is running
 *          (APB2 = 90 MHz / 8, safely under the DW3000's SPI clock limit)
 * */
